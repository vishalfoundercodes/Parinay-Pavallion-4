...
//         <div className="mt-12">
//           <p className="font-bold text-secondary mb-4">Follow Us</p>
//           <div className="flex gap-4">
//             <a
//               href="#"
//               className="p-2 bg-white/10 rounded-full hover:bg-secondary hover:text-primary transition"
//             >
//               <Instagram size={20} />
//             </a>
//             <a
      ...
      <div className="grid md:grid-cols-2 gap-12 bg-white rounded-lg shadow-xl overflow-hidden">
        ...
        <div className="bg-primary p-10 text-white">
          ...
          <div className="mt-12">
            ...
            <div className="flex gap-4">
              <a
                className="p-2 bg-white/10 rounded-full hover:bg-secondary hover:text-primary transition cursor-pointer"
                onClick={() => {
